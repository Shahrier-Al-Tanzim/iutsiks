            ...
            <div class="bg-gray-800 rounded-lg shadow p-8">
                ...
                <form method="POST" action="{{ route('events.store') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="description" name="description" rows="4" class="w-full rounded border-gray-600 bg-gray-900 text-green-100 focus:ring-green-400 focus:border-green-400">{{ old('description') }}</textarea>
                    </div>
                    <div class="mb-4">
                        <label class="block text-green-200 mb-2" for="event_date">Date</label>
                        <input id="event_date" name="event_date" type="date" class="w-full rounded border-gray-600 bg-gray-900 text-green-100 focus:ring-green-400 focus:border-green-400" value="{{ old('event_date') }}" required>
                    </div>
                    <div class="mb-4">
